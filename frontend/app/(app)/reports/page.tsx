...
export default function ReportsPage() {
  ...
  const reportTypes = [
    ...
    },
    {
      ...
      icon: TrendingUp,
      color:
        "bg-purple-100/50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400",
    },
    {
      id: "compliance",
  ...
  const typeBadge = (type: string) => {
    const map: Record<string, string> = {
      ...
      annual:
        "bg-purple-100/50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400",
      compliance:
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          ...
          <Card
            key={label}
            className="border-border/50 group cursor-default hover:shadow-md transition-all duration-300"
          >
                  ...
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        {" · "}{" "}
                        {new Date(report.generated).toLocaleTimeString([], {
                          hour: "2-digit",
                          minute: "2-digit",
                        })}
                      </p>
